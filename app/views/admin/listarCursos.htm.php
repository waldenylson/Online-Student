...
<div id="corpo">
	<div class="divCabecalho">
		...
		<div class="divPeriodo">     <b><strong>&nbsp;PERIODO     </strong></b></div>
		<div class="divDescricao">     <b><strong>&nbsp;DESCRIÇÃO     </strong></b></div>

	</div>
	<?php if(!empty($dados)) foreach($dados as $row) { ?>   
		<div class="divListagem">
			<div class="divNome"><?php echo '&nbsp;&nbsp;&nbsp;' . $row['nome']; ?></div>
			<div class="divPeriodo">     <?php echo '&nbsp;&nbsp;&nbsp;' . $row['periodos'];      ?></div>
			<div class="divDescricao">     <?php echo '&nbsp;&nbsp;&nbsp;' . $row['descricao'];      ?></div>
