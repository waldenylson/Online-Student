...
<div id="keywordDIV">
    <fieldset class="borda">
    	<legend><b><i>&nbsp;.:&nbsp;Pesquisa R&aacute;pida de Cadeiras&nbsp;:.&nbsp;</i></b></legend>
        <form action="<?php echo Mapper::url("/admin/pesquisarCadeiras"); ?>" method="post">        
            <strong>Nome Cadeira:</strong>
...
<table>
    ...
    <thead>
        ...
        <tr>            
            ...
            <td>            	
                <a href="<?php echo Mapper::url("/cadeiras/editar/"  . $row['id']); ?>" title=" Editar Cadeira  " rel="shadowbox" >&nbsp;<?php echo $html->image("acoes/b_edit.png", array("border" => "0")); ?>&nbsp;</a>
            	<a href="<?php echo Mapper::url("/cadeiras/deletar/" . $row['id']); ?>" title=" Excluir Cadeira " rel="shadowbox;height=100;width=220" >&nbsp;<?php echo $html->image("acoes/b_drop.png", array("border" => "0")); ?>&nbsp;</a>
            </td>                        
        </tr>       
        <?php } ?>
    </thead>   
