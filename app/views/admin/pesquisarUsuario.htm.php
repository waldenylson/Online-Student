...
<div id="keywordDIV">
    <fieldset class="borda">
    	<legend><b><i>&nbsp;.:&nbsp;Pesquisa R&aacute;pida de Usu&aacute;rios&nbsp;:.&nbsp;</i></b></legend>
        <form action="<?php echo Mapper::url("/admin/pesquisarUsuario"); ?>" method="post">        
...
<table>
    ...
    <thead>
        ...
        <tr>
            ...
            <td>            	
                <a href="<?php echo Mapper::url("/usuarios/editar/"  . $row['id']); ?>" title=" Editar Usuário "  rel="shadowbox" >&nbsp;<?php echo $html->image("acoes/b_edit.png", array("border" => "0")); ?>&nbsp;</a>
            	<a href="<?php echo Mapper::url("/usuarios/deletar/" . $row['id']); ?>" title=" Excluir Usuário " rel="shadowbox;height=100;width=220" >&nbsp;<?php echo $html->image("acoes/b_drop.png", array("border" => "0")); ?>&nbsp;</a>
                <a href="<?php echo Mapper::url("/usuarios/novoLogin/" . $row['id']); ?>" title=" Login de Usuário " rel="shadowbox" >&nbsp;<?php echo $html->image("acoes/s_loggoff.png", array("border" => "0")); ?>&nbsp;</a>
            </td>                        
        </tr>       
        <?php } ?>
    </thead>   
