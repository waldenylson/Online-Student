...
<div id="keywordDIV">
    <fieldset class="borda">
        ...
        <form action="<?php echo Mapper::url("/admin/pesquisarRelacaoCadeiraCurso"); ?>" method="post">        
...
<table>
	<thead>    
        <tr style="border: 1px solid #000;">
            <th style="width: 40%;">&nbsp;&nbsp;NOME CURSO</th>
    ...
    <thead>
        ...
        <tr>            
            <td><?php echo $row['cursoNome'];   ?>&nbsp;&nbsp;&nbsp;</td>
            <td><?php echo $row['cadeiraNome']; ?>&nbsp;&nbsp;&nbsp;</td>            
            <td>            	
                <a href="<?php echo Mapper::url("/cadeirascursos/editar/"  . $row['id']); ?>" title=" Editar Rela&ccedil;&atilde;o " rel="shadowbox" >&nbsp;<?php echo $html->image("acoes/b_edit.png", array("border" => "0")); ?>&nbsp;</a>
            	<a href="<?php echo Mapper::url("/cadeirascursos/deletar/" . $row['id']); ?>" title=" Excluir Rela&ccedil;&atilde;o " rel="shadowbox;height=100;width=220" >&nbsp;<?php echo $html->image("acoes/b_drop.png", array("border" => "0")); ?>&nbsp;</a>
            </td>                        
        </tr>       
        <?php } ?>
    </thead>   
