<form name="novoUsuario" id="novoUsuario" action="<?php echo Mapper::url("/usuarios/novo"); ?>" method="post" onsubmit="">
	<fieldset class="borda1">
        <legend><b><i>&nbsp;.:&nbsp;Cadastro de Usuários&nbsp;:.&nbsp;</i></b></legend>    
        <table width="560" border="0" cellpadding="3" cellspacing="0" class="borda2">
            ...
            <tr bgcolor="#e6e9ee" height="25">
                <td width="10%"><b>Tel Celular:</b></td>
            ...
            <tr bgcolor="#e6e9ee" height="25">
            	...
            	<td>
            		<input class="radio" type="radio" name="nivel" id="nivel" value="2" checked="checked" /><b>Usuário</b>
                	<input class="radio" type="radio" name="nivel" id="nivel" value="3" /><b>Administrador</b>
            	</td>
            </tr>            
        </table>
