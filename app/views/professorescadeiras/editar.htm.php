<form name="novaRelacao" id="novaRelacao" action="<?php echo Mapper::url("/professorescadeiras/editar/{$relacao['id']}"); ?>" method="post" onsubmit="">
            ...
            <tr bgcolor="#f7f7f7" height="25">
                ...
                <td>
                	<select id="professor_id" name="professor_id" style="width: auto;">
                		<?php foreach($nomeProfessor as $row) { ?>
                    	<option value="<?php echo $row['id']; ?>" selected="selected"><?php echo $row['nome']; ?></option>
                    	<?php } ?>
            ...
            <tr bgcolor="#e6e9ee" height="25">
                ...
                <td>
                	<select id="cadeira_id" name="cadeira_id" style="width: auto;">
                		<?php foreach($nomeCadeira as $row) { ?>
                    	<option value="<?php echo $row['id']; ?>" selected="selected"><?php echo $row['nome']; ?></option>
                    	<?php } ?>
